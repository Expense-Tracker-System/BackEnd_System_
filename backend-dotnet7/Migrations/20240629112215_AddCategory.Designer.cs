...
namespace backend_dotnet7.Migrations
{
    ...
    [Migration("20240629112215_AddCategory")]
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 800,
                            CategoryId = 1,
                            Created = new DateTime(2024, 6, 29, 16, 52, 14, 801, DateTimeKind.Local).AddTicks(5950),
                            Note = "Ileccity Bill",
                            Status = 2
                        },
                        new
                        {
                            ...
                            Amount = 200,
                            CategoryId = 2,
                            Created = new DateTime(2024, 6, 29, 16, 52, 14, 801, DateTimeKind.Local).AddTicks(5963),
                            Note = "Elecity Bill",
                            Status = 2
                        },
                        new
                        {
                            ...
                            Amount = 500,
                            CategoryId = 3,
                            Created = new DateTime(2024, 6, 29, 16, 52, 14, 801, DateTimeKind.Local).AddTicks(5964),
                            Note = "water Bill",
                            Status = 2
                        },
                        new
                        {
                            ...
                            Amount = 1000,
                            CategoryId = 4,
                            Created = new DateTime(2024, 6, 29, 16, 52, 14, 801, DateTimeKind.Local).AddTicks(5966),
                            Note = "Medicine",
                            Status = 2
                        });
                });
