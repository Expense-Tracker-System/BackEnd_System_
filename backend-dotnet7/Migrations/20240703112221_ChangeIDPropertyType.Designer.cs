...
namespace backend_dotnet7.Migrations
{
    ...
    [Migration("20240703112221_ChangeIDPropertyType")]
    partial class ChangeIDPropertyType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.Organization", b =>
                {
                    ...
                    b.Property<float>("TotalGetAmount")
                        .HasColumnType("real");

                    b.Property<float>("TotalTakeAmount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.UserExpense", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate2")
                        .HasColumnType("datetime2");
